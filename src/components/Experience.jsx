  ...
  return (
    <div className='experience bg-black w-screen text-white pt-16 overflow-x-hidden' id='experience'>
      <div className='pt-12 sm:px-16'>
        ...
        <h2 className='text-4xl sm:text-5xl font-extrabold mt-2'>Work Experience And Certification.</h2>
      </div>
      <VerticalTimeline className='mt-9'>
        {experiences.map((experience) => (
          <VerticalTimelineElement
            key={experience.role} // Added unique key for each element
            ...
            icon={
              <a 
                ...
                aria-label={`Visit ${experience.company}`} // Accessibility improvement
              >
                <img
                  src={experience.logo}
      ...
      <Footer /> {/* Ensure footer is included if needed */}
    </div>
  );
}
